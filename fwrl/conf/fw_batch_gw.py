...
from ..alg.fw_batch import FWTabularBatch
...
@extended_kwprop
def fw_batch_gw_play(
        confname       = "fw_batch_gw_play",
        seed           = 0,
        nepisodes      = 1,
        max_steps      = 500,
        ...
        logger              = prop(lambda s: s.logger_factory("FWTabularBatchLogger")),
